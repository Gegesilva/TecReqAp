	...
	<section class="container-fluid">
		...
		<a href="<?php echo $Url;?>/login.php"><button class="btn-logoff"></button></a>
				...
				<!-- Filtro Estado -->
				 ...
				 <select class="selectEstado" id="Estado" name="Estado" onchange="this.form.submit()" required>        
						<option name='Estado' value="1">Todos</option>
								<?php
									...
									$opcao1 .= "<option disabled selected>Estados</option>
												</select>";
					...
					<select class="selectBairro" id="Bairro" name="Bairro" required>        
						<option name='Bairro' value="1">Todos</option>
								<?php
									...
									$opcao1 .= "<option disabled selected>Bairros</option>
												</select>";
